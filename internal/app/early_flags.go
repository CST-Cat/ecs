...
// stripExplicitLanguage removes every global language occurrence before a
// non-run-like command-specific flag set sees argv. Invalid occurrences are
// removed too: Main validates the final occurrence before dispatching, so such
// a subcommand has no second language source or interpretation.
