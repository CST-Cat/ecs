...
func catalogsFor(lang Lang) []map[string]string {
	switch lang {
	case LangEN:
		return []map[string]string{modelMessageEnglish, probeCPUEnglish, probeMemoryEnglish, probePressureEnglish, probeRetryEnglish, reportRetryEnglish, probeMemoryInventoryEnglish, probePortsEnglish, probeRDNSEnglish, probeKernelEnglish, probeSystemEnglish, probeNPBEnglish, probeZstdEnglish, probeCryptoEnglish, probeDiskEnglish, probeDNSEnglish, probeLatencyEnglish, probeNATEnglish, probeAppsEnglish, probeBlacklistEnglish, probeBGPEnglish, probeSpeedEnglish, probeCNSpeedEnglish, probeOoklaEnglish, probeNetworkEnglish, probeMediaEnglish, probeRouteEnglish, probeBacktraceEnglish, compareFlagEnglish, errorEnglish, scoreEnglish, cliEnglish, english}
	default:
		return []map[string]string{modelMessageChinese, probeCPUChinese, probeMemoryChinese, probePressureChinese, probeRetryChinese, reportRetryChinese, probeMemoryInventoryChinese, probePortsChinese, probeRDNSChinese, probeKernelChinese, probeSystemChinese, probeNPBChinese, probeZstdChinese, probeCryptoChinese, probeDiskChinese, probeDNSChinese, probeLatencyChinese, probeNATChinese, probeAppsChinese, probeBlacklistChinese, probeBGPChinese, probeSpeedChinese, probeCNSpeedChinese, probeOoklaChinese, probeNetworkChinese, probeMediaChinese, probeRouteChinese, probeBacktraceChinese, compareFlagChinese, errorChinese, scoreChinese, cliChinese, chinese}
	}
}
