...
func catalogsFor(lang Lang) []map[string]string {
	switch lang {
	case LangEN:
		return []map[string]string{modelMessageEnglish, probeMessageEnglish, probeMemoryInventoryEnglish, probeStage9English, compareFlagEnglish, errorEnglish, scoreEnglish, cliEnglish, english}
	default:
		return []map[string]string{modelMessageChinese, probeMessageChinese, probeMemoryInventoryChinese, probeStage9Chinese, compareFlagChinese, errorChinese, scoreChinese, cliChinese, chinese}
	}
}
