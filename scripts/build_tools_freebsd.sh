...
freebsd_write_manifest() {
  ...
  --argjson npb_ep_source_patches "$npb_ep_source_patches_json" --argjson npb_ft_source_patches "$npb_ft_source_patches_json" \
